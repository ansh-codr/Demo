...
interface BackendProductFormProps {
  onContentGenerated: (content: { title: string; description: string; features: string[] }) => void;
  isLoading: boolean;
  setIsLoading: (loading: boolean) => void;
}

export const BackendProductForm = ({ onContentGenerated, isLoading, setIsLoading }: BackendProductFormProps) => {
  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>
          Enter your product details to generate SEO-optimized content
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        ...
        <div className="flex gap-3">
          ...
          <Button 
            ...
            disabled={isLoading || !productData.product_name.trim()}
            className="flex-1"
          >
